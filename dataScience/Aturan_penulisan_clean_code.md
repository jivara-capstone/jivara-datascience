...
> **Aturan terpenting:** Jangan pernah meninggalkan kode berantakan. Lakukan refactoring sebelum melanjutkan, selagi konteks masih segar di kepala.
...
```python
# elalu tuliskan nama parameter saat memanggil fungsi
